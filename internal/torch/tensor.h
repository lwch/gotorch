...
GOTORCH_API tensor tensor_arange(char **err, int end, int8_t dtype,
                                 int8_t device);
GOTORCH_API tensor tensor_zeros(char **err, int64_t *shape, size_t shape_len,
                                int8_t dtype, int8_t device);
GOTORCH_API tensor tensor_from_data(char **err, void *data, int64_t *shape,
                                    size_t shape_len, int8_t dtype,
                                    int8_t device);
...
GOTORCH_API tensor tensor_to_scalar_type(char **err, tensor t,
                                         int8_t scalar_type);
// shapes
GOTORCH_API tensor tensor_reshape(char **err, tensor t, int64_t *shape,
                                  size_t shape_len);
GOTORCH_API tensor tensor_transpose(char **err, tensor t, int64_t dim1,
                                    int64_t dim2);
GOTORCH_API tensor tensor_narrow(char **err, tensor t, int64_t dim,
...
GOTORCH_API tensor tensor_view(char **err, tensor a, int64_t *shape,
                               size_t shape_len);
GOTORCH_API tensor tensor_permute(char **err, tensor a, int64_t *dims,
                                  size_t dims_len);
// property
...
// utils
GOTORCH_API tensor scaled_dot_product_attention(char **err, tensor q, tensor k,
                                                tensor v, tensor mask,
                                                double dropout, bool is_causal);
GOTORCH_API void clip_grad_norm(char **err, tensor *params, size_t params_count,
                                double max_norm, double norm_type);
GOTORCH_API void tensor_print(tensor t);
GOTORCH_API tensor tensor_cat(char **err, tensor *tensors, size_t tensors_len,
                              int64_t dim);
GOTORCH_API tensor tensor_embedding(char **err, tensor weight, tensor indices,
                                    int64_t padding_idx);
...
GOTORCH_API tensor tensor_flatten(char **err, tensor t, int64_t start_dim,
                                  int64_t end_dim);
// init
