...
extern "C"
{
    ...
    GOTORCH_API optimizer new_adam_optimizer(char **err, tensor *params, size_t params_count, double lr, double beta1,
                                             double beta2, double eps, double weight_decay);
    GOTORCH_API optimizer new_adamw_optimizer(char **err, tensor *params, size_t params_count, double lr, double beta1,
