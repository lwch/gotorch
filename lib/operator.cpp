...
tensor tensor_matmul(char **err, tensor a, tensor b) {
  return auto_catch_tensor(
      [a, b]() { return new torch::Tensor(a->matmul(*b)); }, err);
}

tensor tensor_add(char **err, tensor a, tensor b) {
  return auto_catch_tensor([a, b]() { return new torch::Tensor(a->add(*b)); },
                           err);
}

tensor tensor_sub(char **err, tensor a, tensor b) {
  return auto_catch_tensor([a, b]() { return new torch::Tensor(a->sub(*b)); },
                           err);
}

tensor tensor_mul(char **err, tensor a, tensor b) {
  return auto_catch_tensor([a, b]() { return new torch::Tensor(a->mul(*b)); },
                           err);
}

tensor tensor_div(char **err, tensor a, tensor b) {
  return auto_catch_tensor([a, b]() { return new torch::Tensor(a->div(*b)); },
                           err);
}

tensor tensor_pow(char **err, tensor a, double n) {
  return auto_catch_tensor([a, n]() { return new torch::Tensor(a->pow(n)); },
                           err);
}
...
tensor tensor_rsqrt(char **err, tensor a) {
  return auto_catch_tensor([a]() { return new torch::Tensor(a->rsqrt()); },
                           err);
}
...
tensor tensor_sum(char **err, tensor a, int64_t dim, bool keepdim) {
  return auto_catch_tensor(
      [a, dim, keepdim]() { return new torch::Tensor(a->sum(dim, keepdim)); },
      err);
}

tensor tensor_mean(char **err, tensor a, int64_t dim, bool keepdim) {
  return auto_catch_tensor(
      [a, dim, keepdim]() { return new torch::Tensor(a->mean(dim, keepdim)); },
      err);
}

tensor tensor_var(char **err, tensor a, int64_t dim, bool unbiased,
                  bool keepdim) {
  return auto_catch_tensor(
      [a, dim, unbiased, keepdim]() {
...
tensor tensor_silu(char **err, tensor a) {
  return auto_catch_tensor([a]() { return new torch::Tensor(torch::silu(*a)); },
                           err);
}

tensor tensor_sigmoid(char **err, tensor a) {
  return auto_catch_tensor([a]() { return new torch::Tensor(a->sigmoid()); },
                           err);
}
...
tensor tensor_softmax(char **err, tensor a, int64_t dim) {
  return auto_catch_tensor(
      [a, dim]() { return new torch::Tensor(a->softmax(dim)); }, err);
}
...
tensor tensor_unsqueeze(char **err, tensor a, int64_t dim) {
  return auto_catch_tensor(
      [a, dim]() { return new torch::Tensor(a->unsqueeze(dim)); }, err);
}

tensor tensor_squeeze(char **err, tensor a, int64_t dim) {
  return auto_catch_tensor(
      [a, dim]() { return new torch::Tensor(a->squeeze(dim)); }, err);
}

tensor tensor_flatten(char **err, tensor a, int64_t start_dim,
                      int64_t end_dim) {
  return auto_catch_tensor(
      [a, start_dim, end_dim]() {
        return new torch::Tensor(a->flatten(start_dim, end_dim));
      },
      err);
}

tensor tensor_contiguous(char **err, tensor a) {
  return auto_catch_tensor([a]() { return new torch::Tensor(a->contiguous()); },
                           err);
}
